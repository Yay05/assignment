...
reSize = () => {
    ...
    if (document.getElementById('width_px').value != "") {
        document.getElementById('img').style.width = document.getElementById('width_px').value + 'px' ;
    }
    ...
    if (document.getElementById('height_px').value != "") {
        document.getElementById('img').style.height = document.getElementById('height_px').value  + 'px';
    }
